...
<head>
    ...
    <title>403 — Доступ запрещён · BAIA ERP</title>
    <style>
...
<body>
    <div class="card">
        ...
        <div class="code">Ошибка 403</div>
        <h1>Доступ запрещён</h1>
        <p>У вас нет прав для этого действия или раздела.<br>Если доступ нужен — обратитесь к администратору.</p>
