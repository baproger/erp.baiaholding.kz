...
<template>
    <div class="space-y-3">
        ...
        <div class="space-y-2">
            <div v-for="d in documents" :key="d.id" class="flex items-center justify-between rounded-md bg-slate-50 px-3 py-2 text-sm">
                <div class="min-w-0">
            ...
            <div v-if="!documents.length" class="py-4 text-center text-sm text-slate-400">Документов нет</div>
        </div>
    </div>
</template>
