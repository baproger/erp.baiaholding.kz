...
<template>
    ...
    <AppLayout>
        ...
        <template v-else>
            ...
            <p class="mt-3 text-xs text-slate-400">Остаток = сумма договора − налог {{ taxRate }}% − расходы. Бонус считается по марже каждой сделки (остаток/сумма): до 10% — нет; 11–20% — 7%; 21–30% — 10%; от 31% — 15% от остатка. Чистая прибыль компании = остаток − бонус.</p>
        </template>
    </AppLayout>
</template>
