    ...
    public function show(Deal $deal, FinanceService $finance): Response
    {
        ...
        return Inertia::render('Deals/Show', [
            ...
            'preDeal' => $preDeal ? [
                ...
                'contract_number' => $preDeal->contract_number,
                ...
                'bin' => $preDeal->bin,
                'client_name' => $preDeal->client_name,
                'client_phone' => $preDeal->client_phone,
                'contract_sum' => (float) $preDeal->contract_sum,
                'purchase_price' => (float) $preDeal->purchase_price,
                'partner_pct' => (float) ($preDeal->partner_pct ?? 0),
                'partner_sum' => (float) ($preDeal->partner_sum ?? 0),
                'delivery' => (float) $preDeal->delivery,
                'assembly' => (float) $preDeal->assembly,
                'commission' => (float) $preDeal->commission,
                'tax' => (float) ($preDeal->tax ?? 0),
                'remainder' => (float) ($preDeal->remainder ?? 0),
