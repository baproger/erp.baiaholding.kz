...
- **Склад:** у каждой компании свой (materials + material_receipts). Приход оформляет admin/director/financist; менеджер видит остатки; цех — нет доступа. Остаток = Σ приходов − списания по материалам из сделок (этап 3, в планах). Страница /warehouse: остатки, поиск, история приходов.
